...
class OperationalStateService:
    ...
    def build_cutoff_state(self) -> CutoffState:
        ...
        return CutoffState(
            ...
            source_column=self.host.workflow_state.cutoff_source_column or self.host.workflow_state.cutoff_target_column or default_target,
            ...
            dynamic_source_column=self.host.workflow_state.dynamic_cutoff_source_column or self.host.workflow_state.dynamic_cutoff_target_column or default_target,
